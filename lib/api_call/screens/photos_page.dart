            ...
            itemBuilder: (ctx, index) {
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text('Album ID :- ${state.photosList[index].albumId.toString()}'),
                    Text('Photo ID :- ${state.photosList[index].id.toString()}'),
                    Text('Albumb Title :- ${state.photosList[index].title!}'),
                        ...
                        Column(
                          children: [
                            ...
                            Image.network(
                              ...
                              state.photosList[index].url!,height: 50,width: 50),
                          ],
                        ),
                        Column(
                          children: [
                            ...
                            Image.network(
                              ...
                              state.photosList[index].thumbnailUrl!,height: 50,width: 50),
                          ],
                        )
                      ],
                    )
