...
abstract class $PersonModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String email, int age, String address});
}
...
class _$PersonModelImpl implements _PersonModel {
  ...
  @override
  String toString() {
    return 'PersonModel(name: $name, email: $email, age: $age, address: $address)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, email, age, address);
...
abstract class _PersonModel implements PersonModel {
  const factory _PersonModel(
      ...
      required final String address}) = _$PersonModelImpl;
